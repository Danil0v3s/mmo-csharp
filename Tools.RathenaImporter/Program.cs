...
var converters = new IYamlToSqlConverter[]
{
    ...
    // Future wave: ElementalDbConverter, BattlegroundDbConverter,
    // CashShopDbConverter, ItemComboConverter, ItemPackageConverter,
    // ItemRandomOptDbConverter, ItemGroupDbConverter, ItemEnchantConverter,
    // LaphineSynthesisConverter, LaphineUpgradeConverter,
    // CastleDbConverter, GuildSkillTreeConverter, JobStatsConverter,
    // StatPointConverter, JobBasePointsConverter, JobExpConverter,
    // ExpHomunConverter, ExpGuildConverter, RefineConverter,
    // AttrFixConverter, SizeFixConverter, LevelPenaltyConverter,
    // ReputationConverter, StatusYmlConverter, AttendanceConverter,
    // MobSummonConverter, MobItemRatioConverter, ChannelsConfConverter,
    // BattleAthenaConfConverter, MapIndexTxtConverter, …
};
