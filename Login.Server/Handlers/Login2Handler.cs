...
[PacketHandler(PacketHeader.CA_LOGIN2)]
public class Login2Handler(ILoginAuthUseCase loginAuthUseCase) : IPacketHandler<LoginSessionData, CA_LOGIN2>
{
    public async Task HandleAsync(LoginSessionData session, CA_LOGIN2 packet)
    {
