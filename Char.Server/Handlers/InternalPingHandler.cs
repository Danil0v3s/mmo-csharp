...
public class InternalPingHandler(IServerReadiness readiness) : IPacketHandler<CharSessionData, CZ_INTERNAL_PING>
{
    public Task HandleAsync(CharSessionData session, CZ_INTERNAL_PING packet)
    {
