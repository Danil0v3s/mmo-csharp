...
namespace Map.Server.Tests.Fakes;

/// <summary>
/// Shared no-op <see cref="IIntifService"/> for handler tests that don't exercise the IPC fan-out.
/// Every method is an inert success default; override-by-composition isn't needed here.
/// </summary>
public class NoOpIntifService : IIntifService
{
