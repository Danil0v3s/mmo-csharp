...
public class CA_LOGIN_PCBANG : IncomingPacket
{
    ...
    public CA_LOGIN_PCBANG() : base(PacketHeader.CA_LOGIN_PCBANG, isFixedLength: true)
    {
    }
    ...
    {
        // header (2) + version (4) + username (24) + password (24) + clienttype (1) + ip (16) + mac (13)
        return 2 + 4 + 24 + 24 + 1 + 16 + 13;
    }
}