...
public class InternalPingHandler(IServerReadiness readiness) : IPacketHandler<MapSessionData, CZ_INTERNAL_PING>
{
    public Task HandleAsync(MapSessionData session, CZ_INTERNAL_PING packet)
    {
