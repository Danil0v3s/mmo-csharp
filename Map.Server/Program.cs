...
// CONV-5: IItemCombosService + ScriptedBonusService were retired —
// combo onActive and per-item onEquip fire through the shared mmo-scripts
// V8 engine via IComboDispatcher / IItemHookDispatcher (registered
// further down) using TS hooks generated by Tools.ItemScriptConvert.
// IItemCombosRepository stays loadable from DI for repository-only
// consumers (admin /reloaditemdb etc.) — only the runtime evaluator
// went away.
