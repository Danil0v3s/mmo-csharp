...
public sealed class WaterScrew : SkillImpl
{
    ...
    public WaterScrew() : base(SkillIds.EL_WATER_SCREW) => _rng = Random.Shared;

    public WaterScrew(ISkillAttackService? skillAttack = null, Random? rng = null) : base(SkillIds.EL_WATER_SCREW)
    {
    ...
    public override void CastendDamageId(Entity src, Entity target, ushort skillLevel, SkillBehaviorContext ctx)
    {
        ...
        foreach (var v in victims)
        {
            ...
            _skillAttack?.SkillAttack(BattleAttackType.Magic, src, src, v, SkillIds.EL_WATER_SCREW_ATK, skillLevel);
        }
    }
}
