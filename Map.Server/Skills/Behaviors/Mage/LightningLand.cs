...
/// SC_SUMMON_ELEMENTAL_PROCELLA caster bonus (+<c>200*lv + 2*SPL</c>)
/// is TODO (SC readback isn't wired in this hook). Splash victims
/// roll 3 % SC_HANDICAPSTATE_LIGHTNINGSTRIKE.</para>
/// </summary>
