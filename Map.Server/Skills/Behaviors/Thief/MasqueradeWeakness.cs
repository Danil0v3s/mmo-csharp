...
/// <summary>
/// SC_WEAKNESS — Masquerade Weakness. Manual port of
/// <c>rathena-fork/src/map/skills/thief/masqueradeweakness.cpp</c>.
/// Same probabilistic SC application pattern as Ignorance.
/// </summary>
public sealed class MasqueradeWeakness : SkillImpl
{
    public MasqueradeWeakness() : base(SkillIds.SC_WEAKNESS) { }
    ...
    public override void CastendNoDamageId(Entity src, Entity target, ushort skillLevel, SkillBehaviorContext ctx)
    {
        ...
        if (System.Random.Shared.Next(100) < rate)
            ctx.Sc?.Start(target, StatusType.Weakness, val1: skillLevel, 0, 0, 0, durationMs: 30_000, src);
