...
/// <summary>
/// SC_ENERVATION — Masquerade Enervation. Manual port of
/// <c>rathena-fork/src/map/skills/thief/masqueradeenervation.cpp</c>.
...
public sealed class MasqueradeEnervation : SkillImpl
{
    ...
    public override void CastendNoDamageId(Entity src, Entity target, ushort skillLevel, SkillBehaviorContext ctx)
    {
        ...
        if (System.Random.Shared.Next(100) < rate)
            ctx.Sc?.Start(target, StatusType.Enervation, val1: skillLevel, 0, 0, 0, durationMs: 30_000, src);
