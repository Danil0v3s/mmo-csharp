...
/// <summary>
/// SC_UNLUCKY — Masquerade Unlucky. Manual port of
/// <c>rathena-fork/src/map/skills/thief/masqueradeunlucky.cpp</c>.
/// Same probabilistic SC application pattern as Ignorance.
/// </summary>
public sealed class MasqueradeUnlucky : SkillImpl
{
    public MasqueradeUnlucky() : base(SkillIds.SC_UNLUCKY) { }
    ...
    public override void CastendNoDamageId(Entity src, Entity target, ushort skillLevel, SkillBehaviorContext ctx)
    {
        ...
        if (System.Random.Shared.Next(100) < rate)
            ctx.Sc?.Start(target, StatusType.Unlucky, val1: skillLevel, 0, 0, 0, durationMs: 30_000, src);
