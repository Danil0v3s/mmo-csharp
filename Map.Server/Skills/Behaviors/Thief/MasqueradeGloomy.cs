...
/// <summary>
/// SC_GROOMY — Masquerade Gloomy. Manual port of
/// <c>rathena-fork/src/map/skills/thief/masqueradegloomy.cpp</c>.
/// Same probabilistic SC application pattern as Ignorance.
/// </summary>
public sealed class MasqueradeGloomy : SkillImpl
{
    public MasqueradeGloomy() : base(SkillIds.SC_GROOMY) { }
    ...
    public override void CastendNoDamageId(Entity src, Entity target, ushort skillLevel, SkillBehaviorContext ctx)
    {
        ...
        if (System.Random.Shared.Next(100) < rate)
            ctx.Sc?.Start(target, StatusType.Groomy, val1: skillLevel, 0, 0, 0, durationMs: 30_000, src);
