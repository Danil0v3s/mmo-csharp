...
public class DatabaseSeeder
{
    ...
    public async Task SeedAsync(CancellationToken ct = default)
    {
        try
        {
            ...
            // Map-server declarative catalogs (generated by
            // Tools.RathenaImporter from rAthena npc/re/*.txt; re-run
            // the importer when those source files change).
            await ExecuteSqlScriptAsync("Seeds/Scripts/seed_warps.sql", ct);
            await ExecuteSqlScriptAsync("Seeds/Scripts/seed_mob_spawns.sql", ct);
            await ExecuteSqlScriptAsync("Seeds/Scripts/seed_map_flags.sql", ct);
