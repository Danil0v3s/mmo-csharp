...
public class InventoryEntityConfiguration : IEntityTypeConfiguration<InventoryEntity>
{
    public void Configure(EntityTypeBuilder<InventoryEntity> builder)
    {
        ...
        builder.Property(e => e.Amount).HasColumnName("amount").HasDefaultValue(0u);
        ...
        builder.Property(e => e.Favorite).HasColumnName("favorite").HasDefaultValue((byte)0);
        ...
        builder.Property(e => e.EquipSwitch).HasColumnName("equip_switch").HasDefaultValue(0u);
