...
public class PickLogEntityConfiguration : IEntityTypeConfiguration<PickLogEntity>
{
    public void Configure(EntityTypeBuilder<PickLogEntity> builder)
    {
        ...
        builder.Property(e => e.Type).HasColumnName("type").HasConversion<string>().IsRequired().HasDefaultValue("P");
        builder.Property(e => e.NameId).HasColumnName("nameid").HasDefaultValue(0u);
        builder.Property(e => e.Amount).HasColumnName("amount").HasDefaultValue(1);
