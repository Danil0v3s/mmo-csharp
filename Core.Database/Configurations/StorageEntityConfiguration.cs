...
public class StorageEntityConfiguration : IEntityTypeConfiguration<StorageEntity>
{
    public void Configure(EntityTypeBuilder<StorageEntity> builder)
    {
        ...
        builder.Property(e => e.Amount).HasColumnName("amount").HasDefaultValue((ushort)0);
        builder.Property(e => e.Equip).HasColumnName("equip").HasDefaultValue(0u);
        builder.Property(e => e.Identify).HasColumnName("identify").HasDefaultValue((ushort)0);
