...
| [Map (MS3 combat / status / skills / mob AI)](map/adjacent/combat.md) | ✅ Foundation 100% / 🔁 Long-tail data | BattleStats + renewal damage calc, auto-attack loop, mob AI, status changes (5 SCs), skill cast + ground units (8 skills), EXP / level / party share, equip → stats, pet/summon AI, sit/stand, items use, stat & skill allocation, trade / shop / storage services, public chat. Strategy-pattern dispatch in skill resolution, item effects, request-action handler, mob-skill conditions. **292 tests green.** Wire packets for trade/shop and the data side of skill_db / item Scripts are the remaining work — service contracts are stable. See [combat.md history](map/adjacent/combat.md#history). |
